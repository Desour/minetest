...
private:
	...
	ClientSoundRef(sound_handle_t handle) : m_handle(handle) {}

	DISABLE_CLASS_COPY(ClientSoundRef)

	static ClientSoundRef *checkobject(lua_State *L, int narg);
