...
For Arch users:
    ...
    sudo pacman -S --needed base-devel libcurl-gnutls cmake linux-api-headers libpng sqlite libogg libvorbis openal freetype2 jsoncpp gmp luajit leveldb ncurses zstd gettext sdl2
